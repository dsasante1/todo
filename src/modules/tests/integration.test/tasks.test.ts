...
//   it('Should fail to update task', (done) => {
//     const token = process.env.USER_TOKEN!;
//     chai
//       .request(App())
//       .put(`${baseUrl}/edit`)
...
//   it('Should change task priority successfully', (done) => {
//     const token = process.env.USER_TOKEN!;
//     chai
//       .request(App())
//       .put(`${baseUrl}/edit`)
...
//   it('Should change task completed status', (done) => {
//     const token = process.env.USER_TOKEN!;
...
//   it('Should fail to change task completed status', (done) => {
//     const token = process.env.USER_TOKEN!;
//     chai
//       .request(App())
//       .patch(`${baseUrl}/status`)
...
//     it('Should fail to fetch all tasks', (done) => {
...
//     it('Should search task successfully', (done) => {
//         const token = process.env.USER_TOKEN!;
//         chai
//             .request(App())
//             .get(`${baseUrl}/search?completed=false&&priority=0`)
//             .set('Authorization', token)
//             .send({
//             })
//             .end((err: any, res: { status: any }) => {
